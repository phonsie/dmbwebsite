<?php
	...
	{	
		if($_POST['submit']=='Login')
		{
			...
			header("Location: shows.php?artistID=6&year=2005");
			exit;
		}	
	}  
...
?>
	The following is a short to-do-list or just special items:
	<h2>
	<a href="sourceDetails.php?sourceID=999999999">Dreaming Tree Unlinked Torrents</a>
	</h2>	
	<h2>
	<a href="shows.php?parseError">Sources not imported yet</a>
	</h2>	
